...
export function buildIndexHtml() {
  ...
  const main = `
    <section class="enhanced-hero" id="hero">
      <div class="container hero-inner">
        ...
        <h1 data-reveal-heading>{{PRIMARY_SERVICE}} you can<br/><span class="accent">count on</span>.</h1>
        <p class="sub" data-reveal>{{HERO_SUBHEADLINE|Residential and light commercial service with confident scheduling: priority dispatch for urgent calls, written estimates, and documented repairs across your primary service markets.}}</p>
